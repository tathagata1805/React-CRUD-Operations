...
const FormModifity = () => {
    ...
    // HANDLING FORM MODIFYING STATES...
    ...
    const modifyUser = () => {
        ...
        // ASSIGNING USER ENTERED VALUE TO THE FIELDS IF DATA GETS VALIDATED
    ...
    return (
        ...
        // FORM LAYOUT WITH NECESSARY FUNCTIONS TO STORE REAL TIME DATA
