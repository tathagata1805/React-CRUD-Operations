...
const FormRegister = () => {
    ...
    // INITIALIZING FORM REGISTERING STATES
    ...
    const saveUser = () => {
        ...
        // REGISTERING NEW USER USING USER INPUT IF DATA GETS VALIDATED..
    ...
    const phoneNumber = (
        <Select defaultValue="91" onChange={(e) => onChange('countryNumber',e)} name="countryNumber" value={data.countryNumber} style={{ width: 75 }}>
    ...
    return (
        ...
        // FORM LAYOUT USING PROPER FUNCTIONALITIES..
